...
import os
import re
from AvengerMusic.Core.Clients.cli import LOG_CLIENT
...
from AvengerMusic import (ASS_CLI_1, ASS_CLI_2, ASS_CLI_3, ASS_CLI_4, ASS_CLI_5, LOG_CLIENT,
...
from AvengerMusic.Utilities.inline import paginate_modules
    ...
    with console.status(
        ...
        for all_module in ALL_MODULES:
            imported_module = importlib.import_module(
                "AvengerMusic.Plugins." + all_module
            )
            if (
